...
import com.ccm.document.notify.listener.SmartSubscriber;
import com.ccm.document.notify.listener.Subscriber;
import com.ccm.document.spi.CIMServiceLoader;
import com.ccm.document.utils.ClassUtils;
import com.ccm.document.utils.MapUtil;
import com.ccm.document.utils.ThreadUtils;
...
public class NotifyCenter {
    ...
    static {
        ...
        String ringBufferSizeProperty = "ccm.document.notify.ring-buffer-size";
        ringBufferSize = Integer.getInteger(ringBufferSizeProperty, 16384);
        
        // The size of the public publisher's message staging queue buffer
        String shareBufferSizeProperty = "ccm.document.notify.share-buffer-size";
        shareBufferSize = Integer.getInteger(shareBufferSizeProperty, 1024);
        
        final Collection<EventPublisher> publishers = CIMServiceLoader.load(EventPublisher.class);
        ...
        DEFAULT_PUBLISHER_FACTORY = (cls, buffer) -> {
            try {
                ...
                throw new ServiceException(ExceptionUtil.getMessage(ex));
            }
        };
