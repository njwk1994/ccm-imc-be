...
/**
 * @Author kekai.huang
 * @Date 2023/9/12 11:30
 * @PackageName:com.ccm.packagemanage.handler.wp
 * @ClassName: WPNewDocHandler
 * @Description: TODO
 * @Version 1.0
 */
@Service
public class WPNewDocHandler extends AbstractPackageProcedureHandler {
    ...
    public Map<String, Object> predictionReservation(PackageProcedureRequest packageProcedureRequest) throws Exception {
        ...
        Map<String, String> requestParams = predictionReservationService.getRequestParams(packageProcedureRequest, workPackage,false);
