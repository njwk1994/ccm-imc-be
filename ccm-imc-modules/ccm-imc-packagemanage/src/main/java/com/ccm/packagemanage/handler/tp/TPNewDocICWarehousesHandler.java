 ...
 * @ClassName: TPNewDocICWarehousesHandler
 * @Description: TODO
 * @Version 1.0
 */
@Service
public class TPNewDocICWarehousesHandler extends AbstractPackageProcedureHandler {
    ...
    protected ProcedureType getProcedureType() {
        return ProcedureType.EN_NewDocICWarehouses;
    }
    ...
    public Map<String, Object> predictionReservation(PackageProcedureRequest packageProcedureRequest) throws Exception {
        ...
        Map<String, String> requestParams = predictionReservationService.getRequestParams(packageProcedureRequest, taskPackage,true);
